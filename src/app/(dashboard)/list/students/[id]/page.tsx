        ...
        <div className="w-full xl:w-1/3 flex flex-col gap-4">
         <div className="bg-white p-4 rounded-md">
            ...
            <div className="mt-4 flex gap-4 flex-wrap text-sm text-gray-500">
                <Link href='' className='p-3 rounded-md bg-schSkyLight'>Student&apos;s  Lessons</Link>
                <Link href='' className='p-3 rounded-md bg-schPurpleLight'>Student&apos;s Teachers</Link>
                <Link href='' className='p-3 rounded-md bg-schYellowLight'>Student&apos;s Results</Link>
                <Link href='' className='p-3 rounded-md bg-pink-50'>Student&apos;s Exams</Link>
                <Link href='' className='p-3 rounded-md bg-schSkyLight'>Student&apos;s Assignments</Link>
            </div>
         </div>
         <Performance/>
         <Announcements/>
