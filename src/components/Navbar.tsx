 ...
 const Navbar = ()=>{
    return (
        <div className="flex items-center justify-between p-4">
            <div className="hidden md:flex items-center gap-2 text-sm rounded-full ring-[1.5px] ring-gray-300 px-2 w-[45%]">
            ...
            <div className="flex flex-col">
                <span className="text-sm leading-3 font-medium">Jhon Doe</span>
